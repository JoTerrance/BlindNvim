...
require("lazy").setup({
  ...
  { 'nvim-treesitter/nvim-treesitter',       build = ':TSUpdate',                            config = function() require(
    "treesitter-config") end,                                                                                                                      enabled = not vscode },
  ...
  { 'folke/which-key.nvim',                  event = "BufWinEnter",                          config = function() require(
    'whichkey-config') end,                                                                                                                        enabled = not vscode },
  ...
  { "hrsh7th/nvim-cmp",               requires = { "KadoBOT/cmp-plugins", config = function() require("cmp-plugins")
        .setup({ files = { ".*\\.lua" } }) end, } },
  ...
  { 'akinsho/toggleterm.nvim', branch = 'main',                            config = function() require(
    'toggleterm-config') end,                                                                                                    enabled = not vscode },
  ...
  --  },
  { 'neoclide/coc.nvim',           branch = 'release',                                 disable = vscode,                                        cond = function() return
    vim.g.vscode ~= nil end },
  ...
  { 'folke/todo-comments.nvim',    dependencies = { "nvim-lua/plenary.nvim" },         config = function() require(
    'todo-comments').setup() end },
  --{'folke/flash.nvim', event = "VeryLazy", opts = {} },
  { 'nvim-pack/nvim-spectre',      dependencies = { "nvim-lua/plenary.nvim" },         config = function() require(
    'spectre').setup() end },
  {
    "yetone/avante.nvim",
