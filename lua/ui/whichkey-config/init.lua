...
wk.add({
  ...
  { "<leader>eN", group = "Neogen", icon = icons.edit },
  { "<leader>eNg", "<cmd>Neogen<cr>", desc = "Generate Docs" },
  { "<leader>eNf", "<cmd>Neogen func<cr>", desc = "Generate Function Docs" },
  { "<leader>eS", group = "SSR", icon = icons.refactor },
