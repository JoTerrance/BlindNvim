...
wk.add({
  -- Core
  { "<space>w", "<cmd>w!<CR>", desc = "Save", icon = { icon = icons.save, hl = BlindReturn("Normal", "@variable") } },
  { "<space>h", "<cmd>nohlsearch<CR>", desc = "Clear Search Highlight", icon = { icon = icons.search, hl = BlindReturn("Normal", "@variable") } },
  { "<space>/", "<Plug>(comment_toggle_linewise_current)", desc = "Toggle Comment", icon = { icon = icons.comment, hl = BlindReturn("Normal", "@variable") } },
  { "<space>/", "<Plug>(comment_toggle_linewise_visual)", desc = "Toggle Comment", mode = "v", icon = { icon = icons.comment, hl = BlindReturn("Normal", "@variable") } },

  -- Buffers
  { "<space>b", group = "Buffers", icon = { icon = icons.buffers, hl = BlindReturn("Normal", "@variable") } },
  ...
  -- Navigation
  { "<space>n", group = "Navigation", icon = { icon = icons.navigation, hl = BlindReturn("Normal", "@variable") } },
  ...
  -- Search
  { "<space>s", group = "Search", icon = { icon = icons.search, hl = BlindReturn("Normal", "@variable") } },
  ...
  { "<space>sF", group = "FZF", icon = { icon = icons.fzf, hl = BlindReturn("Normal", "@variable") } },
  ...
  { "<space>sT", group = "TODO", icon = { icon = icons.todo, hl = BlindReturn("Normal", "@variable") } },
  ...
  { "<space>sx", group = "Telescope Extras", icon = { icon = icons.telescope, hl = BlindReturn("Normal", "@variable") } },
  ...
  -- Tools
  { "<space>u", group = "Tools", icon = { icon = icons.tools, hl = BlindReturn("Normal", "@variable") } },
  { "<space>uC", group = "CMake", icon = { icon = icons.cmake, hl = BlindReturn("Normal", "@variable") } },
  ...
  { "<space>uD", group = "DevContainer", icon = { icon = icons.devcontainer, hl = BlindReturn("Normal", "@variable") } },
  ...
  { "<space>uL", group = "Lazy", icon = { icon = icons.lazy, hl = BlindReturn("Normal", "@variable") } },
  ...
  { "<space>uM", group = "Mason", icon = { icon = icons.mason, hl = BlindReturn("Normal", "@variable") } },
  ...
  { "<space>uK", group = "Kubectl", icon = { icon = icons.kubectl, hl = BlindReturn("Normal", "@variable") } },
  ...
  { "<space>uH", group = "HTTP", icon = { icon = icons.http, hl = BlindReturn("Normal", "@variable") } },
  { "<space>uHa", "<cmd>Hyper<cr>", desc = "Open Request" },
  { "<space>uHi", "<cmd>HyperJump<cr>", desc = "Jump Request" },

  -- Database
  { "<space>ud", group = "Database", icon = { icon = icons.database, hl = BlindReturn("Normal", "@variable") } },
  ...
  -- Treesitter
  { "<space>ut", group = "Treesitter", icon = { icon = icons.treesitter, hl = BlindReturn("Normal", "@variable") } },
